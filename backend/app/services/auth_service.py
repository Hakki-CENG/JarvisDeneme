...
class AuthService:
    ...
    def _bootstrap_if_needed(self) -> None:
        ...
        admin = settings.admin_api_token or secret_vault.get_secret('ADMIN_API_TOKEN', consumer='auth_service.bootstrap')
        user = settings.user_api_token or secret_vault.get_secret('USER_API_TOKEN', consumer='auth_service.bootstrap')
        if admin and user:
            return
    ...
    def _admin_token(self) -> str:
        return settings.admin_api_token or secret_vault.get_secret('ADMIN_API_TOKEN', consumer='auth_service.admin_lookup') or ''

    def _user_token(self) -> str:
        return settings.user_api_token or secret_vault.get_secret('USER_API_TOKEN', consumer='auth_service.user_lookup') or ''
